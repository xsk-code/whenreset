...
export function MarioHeader({ totalResets, onOpenSubscribe }: MarioHeaderProps) {
      ...
      <div className="mt-3 pt-3 border-t-2 border-black flex flex-col md:flex-row md:items-center md:justify-between gap-3">
        ...
        <div className="flex flex-wrap items-center gap-2 font-pixel text-[10px]">
          ...
          <a
            ...
            className="px-2.5 py-1.5 border-2 border-black bg-[#0F111A] text-gray-300 hover:text-mario-coin shadow-pixel-sm transition-all rounded-none"
          >
            /api/status
          </a>
          <a
